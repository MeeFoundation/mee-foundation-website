...
<Accordion title="Where is human data stored">
...
<Accordion title="Data sharing" className="not-prose">
...
<Accordion title="Replication" className="not-prose">
...
<Accordion title="Exclusivity" className="not-prose">
...
<Accordion title="User-exclusive personal data" className="not-prose">
...
<Accordion title="Conclusion" className="not-prose">
...
<Accordion title="References" className="not-prose">
...
<Accordion title="Notes" className="not-prose">
